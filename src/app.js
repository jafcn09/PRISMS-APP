...
export class App {
    ...
    setupRoutes() {
        ...
        this.app.post('/webhook', AuthMiddleware.verifyWebhookSignature, async (req, res) => {
            ...
            this.webhookController = new WebhookController(githubService, this.analysisRepository);
    ...
    async getInstallationToken(installationId) {
        ...
        const response = await octokit.request('POST /app/installations/{installation_id}/access_tokens', { installation_id: installationId });
